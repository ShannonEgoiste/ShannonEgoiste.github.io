function flagSelector(listCountry,cbk,showFlag){
	...
	listCountryTable.innerHTML = "";

	listCountry.forEach((x)=>{
		listCountryTable.innerHTML+="<tr data-iso='"+x.i+"' data-name='"+x.n+"'>"+(showFlag?"<td><img height='24px' src='svg/"+x.i+".svg'/></td>":"")+"<td>"+x.n+"</td></tr>";
	});
